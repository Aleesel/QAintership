...
class LogMsg:
    """
    Базовый класс для построения логов AssertionError. Конструирует сообщение в свое поле _msg.
    """
...
def assert_left_in_right_json(response, exp_json, actual_json):
    ...
    :param actual_json: полученный json
...
def assert_response_body_fields(request, response, exp_obj=None, rmv_ids=False):
    """
